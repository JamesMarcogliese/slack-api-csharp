...
namespace Slack.Api.CSharp.WebApi
{
    ...
    public partial interface IGroups
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<MarkOKResponseModel>> MarkWithHttpMessagesAsync(string token = default(string), double? ts = default(double?), string channel = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
