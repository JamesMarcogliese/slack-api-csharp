...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class MembersErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the MembersErrorModel class.
        /// </summary>
        public MembersErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'invalid_limit', 'invalid_cursor', 'fetch_members_failed',
        ...
        public MembersErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for MembersErrorModel class.
        /// </summary>
        static MembersErrorModel()
        {
            Ok = false;
        }
