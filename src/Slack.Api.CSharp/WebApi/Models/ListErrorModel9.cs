...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ListErrorModel9
    {
        /// <summary>
        /// Initializes a new instance of the ListErrorModel9 class.
        /// </summary>
        public ListErrorModel9()
        {
            CustomInit();
        }
        ...
        public ListErrorModel9(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ListErrorModel9 class.
        /// </summary>
        static ListErrorModel9()
        {
            Ok = false;
        }
