...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ConnectErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the ConnectErrorModel class.
        /// </summary>
        public ConnectErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'fatal_error'</param>
        public ConnectErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ConnectErrorModel class.
        /// </summary>
        static ConnectErrorModel()
        {
            Ok = false;
        }
