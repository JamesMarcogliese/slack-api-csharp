...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ArchiveErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the ArchiveErrorModel1 class.
        /// </summary>
        public ArchiveErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'not_supported', 'channel_not_found', 'already_archived',
        /// 'cant_archive_general', 'restricted_action', 'not_authed',
        ...
        public ArchiveErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for ArchiveErrorModel1 class.
        /// </summary>
        static ArchiveErrorModel1()
        {
            Ok = false;
        }
