...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class InfoErrorModel7
    {
        /// <summary>
        /// Initializes a new instance of the InfoErrorModel7 class.
        /// </summary>
        public InfoErrorModel7()
        {
            CustomInit();
        }
        ...
        /// 'user_not_visible', 'not_authed', 'invalid_auth',
        ...
        public InfoErrorModel7(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for InfoErrorModel7 class.
        /// </summary>
        static InfoErrorModel7()
        {
            Ok = false;
        }
