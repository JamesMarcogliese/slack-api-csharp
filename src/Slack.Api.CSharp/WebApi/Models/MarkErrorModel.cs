...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class MarkErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the MarkErrorModel class.
        /// </summary>
        public MarkErrorModel()
        {
            CustomInit();
        }
        ...
        public MarkErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for MarkErrorModel class.
        /// </summary>
        static MarkErrorModel()
        {
            Ok = false;
        }
