...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class RenameErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the RenameErrorModel class.
        /// </summary>
        public RenameErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'not_in_channel', 'not_authorized', 'invalid_name', 'name_taken',
        /// 'invalid_name_required', 'invalid_name_punctuation',
        /// 'invalid_name_maxlength', 'invalid_name_specials', 'not_authed',
        ...
        /// 'fatal_error'</param>
        public RenameErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for RenameErrorModel class.
        /// </summary>
        static RenameErrorModel()
        {
            Ok = false;
        }
