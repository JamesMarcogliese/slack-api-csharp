...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class CloseErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the CloseErrorModel class.
        /// </summary>
        public CloseErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'method_not_supported_for_channel_type', 'channel_not_found',
        /// 'user_does_not_own_channel', 'missing_scope', 'not_authed',
        ...
        public CloseErrorModel(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for CloseErrorModel class.
        /// </summary>
        static CloseErrorModel()
        {
            Ok = false;
        }
