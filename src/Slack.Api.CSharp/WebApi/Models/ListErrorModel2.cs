...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ListErrorModel2
    {
        /// <summary>
        /// Initializes a new instance of the ListErrorModel2 class.
        /// </summary>
        public ListErrorModel2()
        {
            CustomInit();
        }
        ...
        public ListErrorModel2(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ListErrorModel2 class.
        /// </summary>
        static ListErrorModel2()
        {
            Ok = false;
        }
