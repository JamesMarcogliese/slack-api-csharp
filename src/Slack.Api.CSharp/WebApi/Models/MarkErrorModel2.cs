...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response im.mark method
    /// </remarks>
    public partial class MarkErrorModel2
    {
        /// <summary>
        /// Initializes a new instance of the MarkErrorModel2 class.
        /// </summary>
        public MarkErrorModel2()
        {
            CustomInit();
        }
        ...
        /// 'invalid_timestamp', 'not_in_channel', 'not_authed',
        ...
        public MarkErrorModel2(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for MarkErrorModel2 class.
        /// </summary>
        static MarkErrorModel2()
        {
            Ok = false;
        }
