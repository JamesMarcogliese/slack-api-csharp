...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class SetPurposeErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the SetPurposeErrorModel class.
        /// </summary>
        public SetPurposeErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'not_in_channel', 'is_archived', 'too_long', 'user_is_restricted',
        ...
        public SetPurposeErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for SetPurposeErrorModel class.
        /// </summary>
        static SetPurposeErrorModel()
        {
            Ok = false;
        }
