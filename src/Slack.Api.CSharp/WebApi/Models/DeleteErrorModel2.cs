...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class DeleteErrorModel2
    {
        /// <summary>
        /// Initializes a new instance of the DeleteErrorModel2 class.
        /// </summary>
        public DeleteErrorModel2()
        {
            CustomInit();
        }
        ...
        /// 'file_deleted', 'cant_delete_file', 'not_authed', 'invalid_auth',
        ...
        public DeleteErrorModel2(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for DeleteErrorModel2 class.
        /// </summary>
        static DeleteErrorModel2()
        {
            Ok = false;
        }
