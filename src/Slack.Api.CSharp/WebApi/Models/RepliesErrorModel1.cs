...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class RepliesErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the RepliesErrorModel1 class.
        /// </summary>
        public RepliesErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'channel_not_found', 'thread_not_found', 'not_authed',
        ...
        public RepliesErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for RepliesErrorModel1 class.
        /// </summary>
        static RepliesErrorModel1()
        {
            Ok = false;
        }
