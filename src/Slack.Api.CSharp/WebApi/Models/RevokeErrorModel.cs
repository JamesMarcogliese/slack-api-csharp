...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class RevokeErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the RevokeErrorModel class.
        /// </summary>
        public RevokeErrorModel()
        {
            CustomInit();
        }
        ...
        public RevokeErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for RevokeErrorModel class.
        /// </summary>
        static RevokeErrorModel()
        {
            Ok = false;
        }
