...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class InfoErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the InfoErrorModel1 class.
        /// </summary>
        public InfoErrorModel1()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the InfoErrorModel1 class.
        /// </summary>
        /// <param name="error">Possible values include: 'bot_not_found',
        ...
        public InfoErrorModel1(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for InfoErrorModel1 class.
        /// </summary>
        static InfoErrorModel1()
        {
            Ok = false;
        }
        ...
        /// <summary>
        /// Gets or sets possible values include: 'bot_not_found',
        /// 'not_authed', 'invalid_auth', 'account_inactive', 'token_revoked',
        /// 'no_permission', 'org_login_required', 'invalid_arg_name',
        /// 'invalid_array_arg', 'invalid_charset', 'invalid_form_data',
        /// 'invalid_post_type', 'missing_post_type', 'team_added_to_org',
