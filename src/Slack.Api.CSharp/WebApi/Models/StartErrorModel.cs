...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// <summary>
    /// rtm.start error schema
    /// </summary>
    /// <remarks>
    /// Schema for error response from rtm.start method
    /// </remarks>
    public partial class StartErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the StartErrorModel class.
        /// </summary>
        public StartErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'migration_in_progress', 'not_authed', 'invalid_auth',
        ...
        /// 'fatal_error'</param>
        public StartErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for StartErrorModel class.
        /// </summary>
        static StartErrorModel()
        {
            Ok = false;
        }
        ...
        /// <summary>
        /// Gets or sets possible values include: 'migration_in_progress',
