...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class SetTopicErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the SetTopicErrorModel1 class.
        /// </summary>
        public SetTopicErrorModel1()
        {
            CustomInit();
        }
        ...
        public SetTopicErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for SetTopicErrorModel1 class.
        /// </summary>
        static SetTopicErrorModel1()
        {
            Ok = false;
        }
