...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class HistoryErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the HistoryErrorModel1 class.
        /// </summary>
        public HistoryErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'channel_not_found', 'invalid_ts_latest', 'invalid_ts_oldest',
        ...
        public HistoryErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for HistoryErrorModel1 class.
        /// </summary>
        static HistoryErrorModel1()
        {
            Ok = false;
        }
