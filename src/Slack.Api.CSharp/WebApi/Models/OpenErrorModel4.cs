...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response from mpim.open method
    /// </remarks>
    public partial class OpenErrorModel4
    {
        /// <summary>
        /// Initializes a new instance of the OpenErrorModel4 class.
        /// </summary>
        public OpenErrorModel4()
        {
            CustomInit();
        }
        ...
        /// 'users_list_not_supplied', 'not_enough_users', 'too_many_users',
        ...
        public OpenErrorModel4(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for OpenErrorModel4 class.
        /// </summary>
        static OpenErrorModel4()
        {
            Ok = false;
        }
        ...
        /// <summary>
        /// Gets or sets possible values include: 'users_list_not_supplied',
