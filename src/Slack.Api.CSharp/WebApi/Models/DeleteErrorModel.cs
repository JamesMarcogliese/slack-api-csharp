...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class DeleteErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the DeleteErrorModel class.
        /// </summary>
        public DeleteErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'channel_not_found', 'cant_delete_message',
        /// 'compliance_exports_prevent_deletion', 'not_authed',
        ...
        /// 'fatal_error'</param>
        public DeleteErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for DeleteErrorModel class.
        /// </summary>
        static DeleteErrorModel()
        {
            Ok = false;
        }
