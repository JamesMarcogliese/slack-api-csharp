...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response from groups.mark method
    /// </remarks>
    public partial class MarkErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the MarkErrorModel1 class.
        /// </summary>
        public MarkErrorModel1()
        {
            CustomInit();
        }
        ...
        public MarkErrorModel1(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for MarkErrorModel1 class.
        /// </summary>
        static MarkErrorModel1()
        {
            Ok = false;
        }
