...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// <summary>
    /// groups.setTopic error schema
    /// </summary>
    /// <remarks>
    /// Schema for error response from groups.setTopic method
    /// </remarks>
    public partial class SetTopicErrorModel2
    {
        /// <summary>
        /// Initializes a new instance of the SetTopicErrorModel2 class.
        /// </summary>
        public SetTopicErrorModel2()
        {
            CustomInit();
        }
        ...
        public SetTopicErrorModel2(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for SetTopicErrorModel2 class.
        /// </summary>
        static SetTopicErrorModel2()
        {
            Ok = false;
        }
