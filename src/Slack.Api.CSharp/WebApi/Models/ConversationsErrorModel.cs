...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ConversationsErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the ConversationsErrorModel class.
        /// </summary>
        public ConversationsErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'invalid_types', 'invalid_cursor', 'invalid_limit', 'not_authed',
        ...
        /// 'fatal_error'</param>
        public ConversationsErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ConversationsErrorModel class.
        /// </summary>
        static ConversationsErrorModel()
        {
            Ok = false;
        }
