...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response groups.list method
    /// </remarks>
    public partial class ListErrorModel6
    {
        /// <summary>
        /// Initializes a new instance of the ListErrorModel6 class.
        /// </summary>
        public ListErrorModel6()
        {
            CustomInit();
        }
        ...
        public ListErrorModel6(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ListErrorModel6 class.
        /// </summary>
        static ListErrorModel6()
        {
            Ok = false;
        }
