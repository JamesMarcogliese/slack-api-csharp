...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class JoinErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the JoinErrorModel1 class.
        /// </summary>
        public JoinErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'channel_not_found', 'is_archived', 'not_authed', 'invalid_auth',
        ...
        public JoinErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for JoinErrorModel1 class.
        /// </summary>
        static JoinErrorModel1()
        {
            Ok = false;
        }
