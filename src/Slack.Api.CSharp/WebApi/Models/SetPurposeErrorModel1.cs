...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class SetPurposeErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the SetPurposeErrorModel1 class.
        /// </summary>
        public SetPurposeErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'channel_not_found', 'not_in_channel', 'is_archived', 'too_long',
        /// 'user_is_restricted', 'not_authed', 'invalid_auth',
        ...
        public SetPurposeErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for SetPurposeErrorModel1 class.
        /// </summary>
        static SetPurposeErrorModel1()
        {
            Ok = false;
        }
