...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response from im.history method
    /// </remarks>
    public partial class HistoryErrorModel3
    {
        /// <summary>
        /// Initializes a new instance of the HistoryErrorModel3 class.
        /// </summary>
        public HistoryErrorModel3()
        {
            CustomInit();
        }
        ...
        public HistoryErrorModel3(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for HistoryErrorModel3 class.
        /// </summary>
        static HistoryErrorModel3()
        {
            Ok = false;
        }
