...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class InfoErrorModel5
    {
        /// <summary>
        /// Initializes a new instance of the InfoErrorModel5 class.
        /// </summary>
        public InfoErrorModel5()
        {
            CustomInit();
        }
        ...
        public InfoErrorModel5(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for InfoErrorModel5 class.
        /// </summary>
        static InfoErrorModel5()
        {
            Ok = false;
        }
