...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class ListErrorModel5
    {
        /// <summary>
        /// Initializes a new instance of the ListErrorModel5 class.
        /// </summary>
        public ListErrorModel5()
        {
            CustomInit();
        }
        ...
        /// 'unknown_type', 'not_authed', 'invalid_auth', 'account_inactive',
        /// 'no_permission', 'user_is_bot', 'invalid_arg_name',
        ...
        public ListErrorModel5(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for ListErrorModel5 class.
        /// </summary>
        static ListErrorModel5()
        {
            Ok = false;
        }
