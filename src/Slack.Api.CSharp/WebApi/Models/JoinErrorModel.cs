...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class JoinErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the JoinErrorModel class.
        /// </summary>
        public JoinErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'name_taken', 'restricted_action', 'no_channel', 'is_archived',
        ...
        /// 'fatal_error'</param>
        public JoinErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for JoinErrorModel class.
        /// </summary>
        static JoinErrorModel()
        {
            Ok = false;
        }
