...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class InviteErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the InviteErrorModel class.
        /// </summary>
        public InviteErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'user_not_found', 'cant_invite_self', 'not_in_channel',
        /// 'already_in_channel', 'is_archived', 'cant_invite',
        /// 'too_many_users', 'ura_max_channels', 'not_authed', 'invalid_auth',
        ...
        public InviteErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for InviteErrorModel class.
        /// </summary>
        static InviteErrorModel()
        {
            Ok = false;
        }
