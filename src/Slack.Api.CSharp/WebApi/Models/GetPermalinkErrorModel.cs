...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class GetPermalinkErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the GetPermalinkErrorModel class.
        /// </summary>
        public GetPermalinkErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'message_not_found', 'not_authed', 'invalid_auth',
        ...
        /// 'fatal_error'</param>
        public GetPermalinkErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for GetPermalinkErrorModel class.
        /// </summary>
        static GetPermalinkErrorModel()
        {
            Ok = false;
        }
