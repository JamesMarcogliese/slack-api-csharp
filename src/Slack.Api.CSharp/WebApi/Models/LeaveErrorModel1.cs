...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class LeaveErrorModel1
    {
        /// <summary>
        /// Initializes a new instance of the LeaveErrorModel1 class.
        /// </summary>
        public LeaveErrorModel1()
        {
            CustomInit();
        }
        ...
        /// 'method_not_supported_for_channel_type', 'last_member',
        /// 'missing_scope', 'channel_not_found', 'is_archived',
        /// 'cant_leave_general', 'not_authed', 'invalid_auth',
        ...
        public LeaveErrorModel1(string error, string needed = default(string), string provided = default(string))
        {
            Error = error;
            Needed = needed;
            Provided = provided;
        ...
        /// <summary>
        /// Static constructor for LeaveErrorModel1 class.
        /// </summary>
        static LeaveErrorModel1()
        {
            Ok = false;
        }
