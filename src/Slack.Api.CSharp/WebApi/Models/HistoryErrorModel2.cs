...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class HistoryErrorModel2
    {
        /// <summary>
        /// Initializes a new instance of the HistoryErrorModel2 class.
        /// </summary>
        public HistoryErrorModel2()
        {
            CustomInit();
        }
        ...
        public HistoryErrorModel2(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for HistoryErrorModel2 class.
        /// </summary>
        static HistoryErrorModel2()
        {
            Ok = false;
        }
