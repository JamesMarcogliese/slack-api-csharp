...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Schema for error response from files.comments.add method
    /// </remarks>
    public partial class AddErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the AddErrorModel class.
        /// </summary>
        ...
        /// 'file_deleted', 'no_comment', 'cant_add', 'not_authed',
        ...
        public AddErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for AddErrorModel class.
        /// </summary>
        static AddErrorModel()
        {
            Ok = false;
        }
