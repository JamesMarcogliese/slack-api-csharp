...
namespace Slack.Api.CSharp.WebApi.Models
{
    ...
    /// </remarks>
    public partial class PostEphemeralErrorModel
    {
        /// <summary>
        /// Initializes a new instance of the PostEphemeralErrorModel class.
        /// </summary>
        public PostEphemeralErrorModel()
        {
            CustomInit();
        }
        ...
        /// 'is_archived', 'msg_too_long', 'no_text', 'restricted_action',
        /// 'too_many_attachments', 'user_not_in_channel', 'not_authed',
        ...
        public PostEphemeralErrorModel(string error)
        {
            Error = error;
            CustomInit();
        }
        /// <summary>
        /// Static constructor for PostEphemeralErrorModel class.
        /// </summary>
        static PostEphemeralErrorModel()
        {
            Ok = false;
        }
